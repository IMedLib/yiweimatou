/*! Summernote v0.7.0 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ ! function(a) {
	...
	var j = {
		...
		m = function() {
			var b = function(b) {
				...
				r = f("TABLE"),
				s = function(a) {
					return !(x(a) || t(a) || u(a) || n(a) || r(a) || w(a))
				},
				t = function(a) {
				...
				E = j.isMSIE && j.browserVersion < 11 ? "&nbsp;" : "<br>",
				F = function(a) {
					return g(a) ? a.nodeValue.length : a.childNodes.length
				},
				G = function(a) {
					var b = F(a);
					return 0 === b ? !0 : g(a) || 1 !== b || a.innerHTML !== E ? d.all(a.childNodes, g) && "" === a.innerHTML ? !0 : !1 : !0
				},
				H = function(a) {
					i(a) || F(a) || (a.innerHTML = E)
				},
				I = function(a, c) {
					for (; a;) {
						if (c(a)) return a;
				...
				la = function(a, b, d) {
					var e = K(b.node, c.eq(a));
					return e.length ? 1 === e.length ? ka(b, d) : e.reduce(function(a, c) {
						return a === b.node && (a = ka(b, d)), ka({
							node: c,
							offset: a ? m.position(a) : F(c)
						}, d)
					}) : null
				},
				ma = function(a, b) {
				...
				ra = function(a, b) {
					...
					var c = na(b);
					return a.style.cssText && (c.style.cssText = a.style.cssText), S(c, d.from(a.childNodes)), R(c, a), pa(a), c
				},
				sa = f("TEXTAREA"),
				ta = function(a, b) {
		...
		n = function(b, e) {
			...
			return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = e, this.initialize = function() {
				...
				var c = a.extend({}, this.options.buttons);
				...
				Object.keys(this.modules).forEach(function(a) {
					...
					f.removeMemo(a)
				}), b.removeData("summernote"), g.removeLayout(b, this.layoutInfo)
			}, this.code = function(a) {
				var b = this.invoke("codeview.isActivated");
				return void 0 === a ? (this.invoke("codeview.sync"), b ? this.layoutInfo.codable.val() : this.layoutInfo.editable.html()) : void(b ? this.layoutInfo.codable.val(a) : this.layoutInfo.editable.html(a))
				...
				c.shouldInitialize() && (c.events && m.detachEvents(b, c.events), c.destroy && c.destroy()), delete this.modules[a], this.modules[a] = null
			}, this.memo = function(a, b) {
				return 1 === arguments.length ? this.memos[a] : void(this.memos[a] = b)
			}, this.removeMemo = function(a) {
				this.memos[a] && this.memos[a].destroy && this.memos[a].destroy(), delete this.memos[a], this.memos[a] = null
	...
	a.summernote = a.summernote || {
		...
		summernote: function() {
			...
			f = a.extend({}, a.summernote.options, f), f.langInfo = a.extend(!0, {}, a.summernote.lang["en-US"], a.summernote.lang[f.lang]), this.each(function(b, c) {
				var d = a(c);
				d.data("summernote") || (d.data("summernote", new n(d, f)), d.data("summernote").triggerEvent("init"))
			});
			var g = this.first();
			if (c && g.length) {
	...
	var o = function(b, c, d, e) {
		...
		E = p.create(['<div class="note-popover popover bottom in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join("")),
		F = function(a, b) {
	...
	var H, I = function() {
		...
		O = function() {
			...
			this.insertTab = function(a, b, c) {
				...
				var d, e = m.ancestor(c.sc, m.isPara);
				if (e) {
					if (m.isEmpty(e) && m.isLi(e)) return void b.toggleList(e.parentNode.nodeName);
					if (m.isEmpty(e) && m.isPara(e) && m.isBlockquote(e.parentNode)) m.insertAfter(e, e.parentNode), d = e;
					else {
						d = m.splitTree(e, c.getStartPoint());
						var f = m.listDescendant(e, m.isEmptyAnchor);
						f = f.concat(m.listDescendant(d, m.isEmptyAnchor)), a.each(f, function(a, b) {
							m.remove(b)
						}), m.isHeading(d) && m.isEmpty(d) && (d = m.replace(d, "p"))
					}
				} else {
					var g = c.sc.childNodes[c.so];
					d = a(m.emptyPara)[0], g ? c.sc.insertBefore(d, g) : c.sc.appendChild(d)
				}
				J.create(d, 0).normalize().select()
			}
		},
		P = function() {
		...
		R = function(b) {
			...
			}, b.memo("help.redo", i.help.redo), this.reset = function() {
				b.triggerEvent("before.command", g.html()), p.reset(), b.triggerEvent("change", g.html())
			}, this.rewind = function() {
				b.triggerEvent("before.command", g.html()), p.rewind(), b.triggerEvent("change", g.html())
			};
			...
			this.tab = function() {
				...
				return K.createImage(a, c).then(function(a) {
					q(), a.css({
						display: "",
						width: Math.min(g.width(), a.width())
					}), J.create().insertNode(a[0]), J.createFromNodeAfter(a[0]).select(), r()
				}).fail(function() {
	...
	var U = function(a) {
				...
				b.memo("button.style", function() {
					...
					return f.buttonGroup({
						...
						children: [f.button({
							...
							items: ["<li>", '<div class="btn-group">', '  <div class="note-palette-title">' + i.color.background + "</div>", '  <div class="note-color-reset" data-event="backColor" data-value="inherit">' + i.color.transparent + "</div>", '  <div class="note-holder" data-event="backColor"/>', "</div>", '<div class="btn-group">', '  <div class="note-palette-title">' + i.color.foreground + "</div>", '  <div class="note-color-reset" data-event="foreColor" data-value="inherit">' + i.color.resetToDefault + "</div>", '  <div class="note-holder" data-event="foreColor"/>', "</div>", "</li>"].join(""),
							callback: function(b) {
		...
		ba = function(b) {
			...
			this.shouldInitialize = function() {
				...
				f.toolbar = f.toolbar || [], f.toolbar.length ? b.invoke("buttons.build", e, f.toolbar) : e.hide(), d.on("summernote.keyup summernote.mouseup summernote.change", function() {
				...
				var a = e.find("button").not(".btn-codeview");
				c.toggleBtn(a, !0)
			}, this.deactivate = function() {
				var a = e.find("button").not(".btn-codeview");
				c.toggleBtn(a, !1)
		...
		ha = function(b) {
			...
			this.createShortCutList = function() {
				...
				var b = f.dialogsInBody ? a(document.body) : e,
					c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.7.0</a> · ', '<a href="//github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
				this.$dialog = d.dialog({
		...
		ia = function(b) {
			...
			this.events = {
				...
				"summernote.focusout": function(a, b) {
					b.relatedTarget && m.ancestor(b.relatedTarget, c.eq(e.$popover[0])) || e.hide()
				}
			}, this.shouldInitialize = function() {
		...
		ja = function(b) {
			...
			this.events = {
				...
				}).render().appendTo("body"), this.$content = this.$popover.find(".popover-content"), this.$content.on("click", ".note-hint-item", function() {
